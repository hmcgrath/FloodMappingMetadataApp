window.heatmap = {
    ...
    loadConservationLayers() {
        return new Promise((resolve, reject) => {
            ...
            $.getJSON("/hydro_dev/api/cacount?countonly=true", (data) => {
    ...
    loadConservationData() {
        return new Promise((resolve, reject) => {  
            $.getJSON("/hydro_dev/api/cacount", (data) => {
                this.cadata = data;
                $.getJSON("/hydro_dev/api/cacount?formatted=true", (summarydata) => {
                    this.casummary = summarydata; 
                    $.getJSON("/hydro_dev/api", (alldata) => {
